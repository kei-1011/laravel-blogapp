            ...
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <img id="account_menu" class="profile_image account_logo" src="/storage/images/user/{{Auth::user()->profile_image}}" alt="{{Auth::user()->screen_name}}" data-user="{{Auth::user()->name}}" data-id="{{Auth::user()->id}}">
